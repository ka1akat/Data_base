...
--in first task our index should be multicolumn because user_id is used in the WHERE clause
...
--The main advantage is that the index is smaller and faster, because it only includes about 40% of the rows
